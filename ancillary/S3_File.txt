...
mct <- read.nexus("ancillary/Supporting_Information_S09.tree")
phy <- read.nexus("ancillary/Supporting_Information_S05_1000_random_trees_no_outgroups.nex")
...
# save as supp. mat. 15
library("ggplot2")
load("ancillary/Supporting_Information_S07_multimedusa_on_1000_trees.txt")
summ <- multiMedusaSummary(res, conTree=mct, cex=0.3)
