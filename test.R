...
# dfg is a list of trees
# res is a list of results
results <- lapply(dfg, runTurboMEDUSA, richness=tax, model.limit=model.limit, mc=TRUE, num.cores=4, stop="model.limit", initial.r=0.05, initial.e=0.5) 
  
  
#for (tree.rep in 1:length(dfg)) {
#my_fun <- function(phy, tax, model.limit, tree.rep) {
