...
%DIF DEL MS_orig.tex      Thu Jan 15 00:00:41 2015
%DIF ADD MS_revised.tex   Thu Jan 15 00:48:08 2015
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{cite}
\usepackage{hyperref}
...
13--14), and found that \DIFdelbegin \DIFdel{some of the changes in }\DIFdelend \DIFaddbegin \DIFadd{the estimated }\DIFaddend net diversification rate
...
feeders was \texttt{r = 0.16} (see Fig. \DIFdelbegin \DIFdel{S2 }\DIFdelend \DIFaddbegin \DIFadd{S1 }\DIFaddend for a boxplot of speciation
...
and net diversification rates (Fig. \DIFdelbegin \DIFdel{S3}\DIFdelend \DIFaddbegin \DIFadd{S2}\DIFaddend ). Therefore, the rest of the
...
speciation rates in Fig. \DIFdelbegin \DIFdel{S4}\DIFdelend \DIFaddbegin \DIFadd{S3}\DIFaddend ; boxplot of 95\% credibility intervals in
Fig. \DIFdelbegin \DIFdel{S5}\DIFdelend \DIFaddbegin \DIFadd{S4}\DIFaddend ). A BiSSE analysis to test whether the trait ``feeding on
...
other plants (Fig. \DIFdelbegin \DIFdel{S6}\DIFdelend \DIFaddbegin \DIFadd{S5}\DIFaddend ).
...
trees, Luke Harmon for commenting on the manuscript\DIFaddbegin \DIFadd{, Jeffrey C. Oliver }\DIFaddend and anonymous
...
following nodes (besides the background rate): \DIFaddbegin \DIFadd{1) root, }\DIFaddend 2) Limenitidinae +
...
\emph{Dryadula}, 17) \emph{Taenaris}, 18) Pseudergolinae\DIFaddbegin \DIFadd{, 19)
}\emph{\DIFadd{Anaeomorpha}} \DIFadd{+ }\emph{\DIFadd{Hypna}}\DIFaddend . Circles on
...
{\bf Figure 2. Diversification rates for taxa estimated by \DIFdelbegin \DIFdel{MEDUSA }\DIFdelend \DIFaddbegin \DIFadd{MultiMEDUSA }\DIFaddend on
...
$\lambda1$, net diversification rate = $r1$\DIFaddbegin \DIFadd{)}\DIFaddend .
...
%DIFDELCMD < {%%%
\textbf{\DIFdel{Figure S2.}}%DIFAUXCMD
%DIFDELCMD < } %%%
