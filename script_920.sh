...
mpirun -np 16 Rscript code/supp_mat_06_multiMEDUSA.R output/variable_topology/set_920.nex output/variable_topology/set_920.nex_mct.nex output/variable_topology/set_920.nex_raw_data_summary.csv output/variable_topology/set_920.nex_raw_data.csv
