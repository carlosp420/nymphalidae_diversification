...
\cite{janz2011,nylin2014} or ``diffuse cospeciation'' \cite{nyman2012}.
...
shifts to closely related hostplants \cite{nylin2014,ferrer2013}.
...
of diversification. We applied MEDUSA \cite{alfaro2009,harmon2011},
...
found by MEDUSA on the MCC tree from \cite{wahlberg2009} (Table 2). Although the
...
co-speciation hypothesis \cite{nyman2012,janz2011}.
