...
Nymphalidae history (Fig.~\ref{fig1}; Table 1). The corrected AICc acceptance
...
(S16 Text and S17 Figure), and found that the estimated net diversification rate
...
feeders was \texttt{r = 0.16} (see S1 Figure for a boxplot of speciation
...
and net diversification rates (S2 Figure). Therefore, the rest of the
...
plot of speciation rates in S3 Figure; boxplot of 95\% credibility intervals in
S4 Figure). A BiSSE analysis to test whether the trait ``feeding on
...
distribution (Fig.~\ref{fig3}, Table 2). We also found that, even though the
...
\textbf{S2 Figure.
BiSSE analysis of diversification of nymphalids
...
\textbf{S7 Dataset.
Species richness for lineages in Nymphalidae}.

\textbf{S8 Dataset.
Hostplants of Nymphalidae
...
\textbf{S10 File.
R script to run MEDUSA on the MCC Nymphalidae tree from
\cite{wahlberg2009}}. This script removes the outgroup
taxa and loads the richness data for the tree terminals.

\textbf{S11 File.
R script to run a MultiMEDUSA analysis on 1000 random trees from
\cite{wahlberg2009}}.

\textbf{S12 Supporting Information.
R script to run a MEDUSA
analysis on the MCC tree from the 1000 random trees selected from the
posterior distribution}.

\textbf{S13 Dataset.
Data matrix with character states for hosplant use}.

\textbf{S14 Supporting Information.
MCC tree from the 1000 random
...
\textbf{S17 Figure.
Probability of nodes with
estimated rates from a MultiMEDUSA run on the 1000 random trees selected
from the posterior distribution}.

\textbf{S18 Supporting Information.
R script for running the BiSSE analysis}.

\textbf{S19 Supporting Information.
Raw results for the BiSSE analysis}.

\textbf{S20 Supporting Information.
Raw results for the combined BiSSE analysis}.

\textbf{S21 Dataset.
MCC Nymphalidae tree from \cite{wahlberg2009}}

\textbf{S22 Text.
Results of running MEDUSA on the MCC tree}.

\textbf{S23 Figure.
Summary of the MultiMEDUSA
analysis on the 1000 trees from the posterior distribution}.

\textbf{S24 Text.
Summary results from a MEDUSA
