...
the software BAMM. We found 
that the best model (best configuration) estimated 8 diversification shifts in
our MCC tree (posterior probability = 0.65). Bayes factor values strongly 
favored this model in comparison with the second best model (7 diversification
shifts, BF > 37,000). <<<<CHECK AGAIN AFTER 2nd BAMM Run >>>
...
45. Brower AVZ, Freitas AVL, Lee M-M, Silva-Brand{\~a}o KL, Whinnett A, et
...
50. Wahlberg N, Rubinoff D (2011) Vagility across \emph{Vanessa} (Lepidoptera:
